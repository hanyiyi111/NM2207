...
**Solution:**  _Character (string of alphabets). Because this is a categoric variable and it is ordinal. The three sentiments have natural ordering._ 
...
**Solution:**  _Character (string of alphabets). We can get the number of selected hashtags by counting how many entries they have. _ 
...
**Solution:**  _I would use a numeric data type because we can use numbers to indicate time._ 
...
**Solution:**  _Character (string of numbers)_ 
...
**Solution:**  _Character (string of alphabets)_ 
...
**Solution:**  _1."PreferredPlatform",non-numeric,character; 2."Gender",non-numeric,character; 3."DailyHoursOfUsage",numeric,double._ 
...
**Solution:** _When different types of vectors are combined, R will automatically convert the vector to accommodate all element types based on the content._
...
**Solution:** R will turn convert double vector into character. I would explicitly coerce the vector to be double.
